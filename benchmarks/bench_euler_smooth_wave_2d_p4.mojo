...
def main() raises:
    ...
    if err4 > L2_MAX_REL:
        raise Error("bench_euler_smooth_wave_2d_p4 FAILED: rel L2 at N=4 " + String(err4) + " exceeds " + String(L2_MAX_REL))
    if err6 > L2_MAX_REL:
        raise Error("bench_euler_smooth_wave_2d_p4 FAILED: rel L2 at N=6 " + String(err6) + " exceeds " + String(L2_MAX_REL))
    if err8 > L2_MAX_REL:
        raise Error("bench_euler_smooth_wave_2d_p4 FAILED: rel L2 at N=8 " + String(err8) + " exceeds " + String(L2_MAX_REL))
