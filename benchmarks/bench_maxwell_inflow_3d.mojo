...
def main() raises:
    ...
    var bcs = BoundaryConditions(BC_INFLOW, BC_INFLOW, BC_INFLOW, BC_INFLOW, BC_INFLOW, BC_INFLOW)
    ...
    if max_drift > DRIFT_TOL:
        raise Error("bench_maxwell_inflow_3d FAILED: drift " + String(max_drift) + " > " + String(DRIFT_TOL))
