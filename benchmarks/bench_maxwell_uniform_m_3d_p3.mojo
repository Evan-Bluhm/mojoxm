...
def main() raises:
    ...
    print("  P=", P, "  NP=", NP, "  mesh=", NX, "x", NY, "x", NZ, "   Mz=", MZ, "   T=", T_FINAL)
    ...
    if max_other > ZERO_COMPONENT_TOL:
        raise Error("bench_maxwell_uniform_m_3d_p3 FAILED: zero-component leak " + String(max_other) + " > " + String(ZERO_COMPONENT_TOL))
