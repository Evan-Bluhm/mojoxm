...
def main() raises:
    ...
    solver.ctx.enqueue_function[transport_ic_kernel_p4, transport_ic_kernel_p4](
    ...
    if psi_max > amp_bound:
        raise Error(
            String("bench_mhd_glm_psi_transport_3d_p4 FAILED: psi_max ")
            + String(psi_max)
