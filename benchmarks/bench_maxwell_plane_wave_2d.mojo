...
def main() raises:
    ...
    if rel > L2_MAX_REL:
        raise Error(String("bench_maxwell_plane_wave_2d FAILED: rel L2 ") + String(rel) + " > " + String(L2_MAX_REL))
    if max_zero_leak > ZERO_COMPONENT_MAX:
        raise Error(String("bench_maxwell_plane_wave_2d FAILED: zero-component ") + "leakage " + String(max_zero_leak) + " > " + String(ZERO_COMPONENT_MAX))
