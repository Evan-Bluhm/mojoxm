...
def main() raises:
    ...
    print("bench_two_fluid_walls_3d_p3 (3D Two-Fluid BC_WALL preservation, P=3)")
    ...
    if max_drift > DRIFT_TOL:
        raise Error("bench_two_fluid_walls_3d_p3 FAILED: max drift " + String(max_drift) + " > " + String(DRIFT_TOL))
