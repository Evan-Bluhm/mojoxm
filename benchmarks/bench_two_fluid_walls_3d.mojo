...
# `FiveMomentTwoFluid.boundary_flux` (src/two_fluid.mojo line 433),
# which after this commit is the only Two-Fluid BC arm without a
# direct gate that's covered.  BC_INFLOW remains untested for
# Two-Fluid (rare in practice; most plasma applications drive
# the system via the J source-coupling that's already exercised
# by the Langmuir bench).
#
