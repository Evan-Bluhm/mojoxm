...
def main() raises:
    ...
    print("  P=", P, "  NP=", NP, "  sweep N=6, 8, 10   (threshold", L2_MAX_REL, ")")
    ...
    if err6 > L2_MAX_REL:
        raise Error("bench_euler_smooth_wave_3d_p4 FAILED: rel L2 at N=6 " + String(err6) + " exceeds " + String(L2_MAX_REL))
    if err8 > L2_MAX_REL:
        raise Error("bench_euler_smooth_wave_3d_p4 FAILED: rel L2 at N=8 " + String(err8) + " exceeds " + String(L2_MAX_REL))
    if err10 > L2_MAX_REL:
        raise Error("bench_euler_smooth_wave_3d_p4 FAILED: rel L2 at N=10 " + String(err10) + " exceeds " + String(L2_MAX_REL))
