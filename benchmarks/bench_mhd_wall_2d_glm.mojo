...
def main() raises:
    ...
    print("  P=", P, "  mesh=", NX, "x", NY, "   B0=", B0, "   T=", T_FINAL, "  (u=0; B tangent to +/-y walls; periodic in x)")
    ...
    if max_drift > REL_TOL:
        raise Error("bench_mhd_wall_2d_glm FAILED: max relative drift " + String(max_drift) + " > " + String(REL_TOL))
