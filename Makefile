...
TEST_DRIVERS = mpi_advection_test mpi_bc_test diagnostics_test p3_smoke_test \
               ...
               mhd_2d_gpu_test limiter_2d_gpu_test limiter_3d_test \
               mhd_3d_test euler_3d_test maxwell_3d_test sw_3d_test \
               two_fluid_3d_test
...
BENCH_DRIVERS = bench_advection_translation_2d \
                bench_advection_translation_2d_p3 bench_euler_vortex_2d \
...
.PHONY: all cpu gpu clean help test test-bc test-reference test-reference-2d test-local-mesh-2d test-local-mesh-2d-gpu test-euler-2d-gpu test-sw-2d-gpu test-mhd-2d-gpu test-limiter-2d-gpu test-limiter-3d test-mhd-3d test-euler-3d test-maxwell-3d test-sw-3d test-two-fluid-3d test-diagnostics test-p3 test-all test-klone bench-all bench-advection-translation-2d bench-euler-vortex-2d bench-mhd-alfven-2d bench-euler-sod-2d
...
test-all: test-reference test-reference-2d test-local-mesh-2d test-local-mesh-2d-gpu test-euler-2d-gpu test-sw-2d-gpu test-mhd-2d-gpu test-limiter-2d-gpu test-limiter-3d test-mhd-3d test-euler-3d test-maxwell-3d test-sw-3d test-two-fluid-3d test-diagnostics test-p3 test test-bc
