...
def main() raises:
    ...
    print("  elements:", gpu_mesh.num_elements, " faces:", gpu_mesh.num_faces, "  nodes/elem:", NP_p, "  total DOF:", gpu_mesh.num_elements * NP_p)
    ...
    dump_pvd_collection(String("output/solution_adv2d_gpu.pvd"), paths, times)
