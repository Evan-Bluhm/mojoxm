...
def main() raises:
    ...
    print("mhd_alfven_glm_2d_gpu (GPU 2D MHD + Dedner GLM, P=", P,
          ",", NX, "x", NY, ")")
    ...
    print("  cf=", cf, "  c_h=", C_H, "  alpha_d=", ALPHA_D,
          "  dt=", dt, "  steps/frame=", steps_per_frame,
    ...
    dump_pvd_collection(
        String("output/solution_mhd_alfven_glm_2d_gpu.pvd"), paths, times,
    )
    print("  wrote output/solution_mhd_alfven_glm_2d_gpu.pvd +",
