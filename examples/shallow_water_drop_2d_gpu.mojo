...
def main() raises:
    ...
    # WARPXM-style device-memory accounting (mirrors the 3D
    # Solver.memory_report path; SW has no BJ limiter so limiter_bytes=0,
    # 2D is np=1 only so halo_*_bytes=0).
    MemoryReport(
