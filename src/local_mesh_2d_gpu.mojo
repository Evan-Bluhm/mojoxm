...
# ======================================================================
# Maxwell 2D physics (NC = 6 with [Ex, Ey, Ez, Bx, By, Bz] layout).
# ======================================================================
# 2D embedding of the full 3D Maxwell equations: kernels iterate over
# triangular elements with 2D normals (nx, ny, nz=0) so only F^x and
# F^y enter the volume RHS.  All six EM components are still tracked,
# matching the 3D Maxwell layout for consistency.  TM mode (Ex=Ey=Bz=0)
# and TE mode (Ez=Bx=By=0) are both representable.
#
...
# zero-gradient on BC_OUTFLOW (matches the 3D Maxwell physics).
# ======================================================================
